...
// Fixed footer that stays at the bottom of the dialog
const MobileDialogFixedFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      "fixed bottom-0 left-0 right-0 p-4 bg-background border-t flex justify-end space-x-2 z-50",
      className,
    )}
    {...props}
  />
)
MobileDialogFixedFooter.displayName = "MobileDialogFixedFooter"
